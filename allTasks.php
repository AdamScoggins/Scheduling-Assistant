...
$all_non_completed_tasks = mysqli_query($mysqli, "SELECT * FROM tasks WHERE username='$current_user' and completed=0 ORDER BY year ASC,month ASC,day ASC;");
$all_completed_tasks = mysqli_query($mysqli, "SELECT * FROM tasks WHERE username='$current_user' and completed=1 ORDER BY year ASC,month ASC,day ASC;");
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php
      if (mysqli_num_rows($all_non_completed_tasks) == 0){
      ...
      while($res = mysqli_fetch_array($all_non_completed_tasks)) {
        echo "<div class='col-lg-12 user_tasks'>";
        echo "<center>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php
      if (mysqli_num_rows($all_completed_tasks) == 0){
        echo "<div class='col-lg-12 user_tasks'>";
        echo "<center>
      ...
      while($res = mysqli_fetch_array($all_completed_tasks)) {
        echo "<div class='col-lg-12 user_tasks'>";
